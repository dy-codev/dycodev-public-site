...
<div class="bg-blue-50/50 border border-blue-100 rounded-xl p-5 my-6">
    ...
    <p class="text-blue-900 text-sm m-0">Materi asli buku ini (diterbitkan 2023) juga mencantumkan <strong class="text-blue-900">Line</strong> dan <strong class="text-blue-900">Skype</strong> sebagai contoh aplikasi komunikasi. Berikut konteks mengapa keduanya sudah kurang relevan dijadikan contoh utama saat ini: </p>
    ...
    <p class="text-blue-900 text-sm m-0">Sebagai gantinya, materi di atas menampilkan <strong class="text-blue-900">Instagram DM</strong> dan <strong class="text-blue-900">Microsoft Teams</strong> sebagai contoh yang lebih mencerminkan pola komunikasi digital masyarakat Indonesia saat ini.</p>
</div>
